...
def functional_description(file):
    ...
    with open(file, 'r') as f:
        for line in f:
            ...
            if line[0] != '#':          # ignore lines starting with '#'
                ...
                gene_id, public_name, molecular_name, concise_description = line.split('\t')[:4]
    ...
    return accession_nr, id_gene, id_locus, func_names
...
if __name__ == '__main__':
    ...
    Accession_NR, ID_gene, ID_locus, Func_names = functional_description(args.Functional_Description)  # ID file
